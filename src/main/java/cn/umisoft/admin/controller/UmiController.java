...
import cn.umisoft.admin.util.mybatisplus.UmiQueryCondition;
...
/**
 * @Description: Umi Controller公共组件，依赖基础Service构建
 * @Author: hujie@umisoft.cn
 * @Date: 2019/2/14 9:41 AM
 */
public class UmiController<S extends IUmiService<T>, T> implements IEntityHelper<T> {
     ...
     */
    Set<String> mappingFields = new HashSet<String>();
